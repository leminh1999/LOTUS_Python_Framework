...
desired_caps = {
    ...
    # "appPackage": "com.ldmnq.launcher3",                         # ⛔CHÚ Ý: Khi gắn appPackage và appActivity thì các icon trên màn hình sẽ bị kéo về vị trí gốc của nó.
    # "appActivity": "com.android.launcher3.Launcher" # ⛔Sẽ thay đổi vị trí và thư mục mà USER đã sắp xếp trên màn hình
}
