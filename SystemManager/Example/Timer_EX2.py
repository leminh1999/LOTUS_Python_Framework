...
Timer.pause()
print(Timer.remainCounterSec) # Mong đợi counter là 20 (Tức 30 - 5)
sleep(5)
print(Timer.remainCounterSec) # Mong đợi counter là 20 vì counter đã bị pause
Timer.resume()
sleep(5)

print(Timer.remainCounterSec) # Mong đợi counter là 15 vì chương trình bị force nhảy đến callback.

### Kết quả: PIC/Timer_EX2.png ###